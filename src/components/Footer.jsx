          ...
          <div class="container-fluid">
            <div class="row order">
              ...
              <div class="col-lg-3 col-md-4 desktop">
                <p>Quick Links</p>
                <ul class="list-unstyled list ">
                <a className="anchor" aria-current="page" href="#about"><li>
                  
                  About
                  
                  </li></a>
                <a className="anchor" aria-current="page" href="#tutorials"><li>
              ...
              <div class="col-lg-3 col-md-4 desktop">
                ...
                <a className="anchor" aria-current="page" href="#shop"><li>
                    Shop
                  </li></a>
                  <a className="anchor" aria-current="page" href="#"><li>
                    Sensify Inc
                  </li></a>
                </ul>
              </div>
